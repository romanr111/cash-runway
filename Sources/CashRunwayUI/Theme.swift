...
enum CategoryAppearanceCatalog {
    ...
    static let icons: [CategoryAppearanceChoice] = [
        ...
        .init(name: "Cart", iconName: "cart.fill", colorHex: "#21C596"),
        ...
        .init(name: "Car", iconName: "car.fill", colorHex: "#F2C230"),
        .init(name: "Bus", iconName: "bus.fill", colorHex: "#F2C230"),
        .init(name: "Fuel", iconName: "fuelpump.fill", colorHex: "#F2C230"),
        .init(name: "Bike", iconName: "bicycle", colorHex: "#88C95A"),
        .init(name: "Walk", iconName: "figure.walk", colorHex: "#88C95A"),
        .init(name: "Travel", iconName: "airplane", colorHex: "#E85D8E"),
        .init(name: "Bills", iconName: "doc.text.fill", colorHex: "#21C596"),
        .init(name: "Wifi", iconName: "wifi", colorHex: "#2AAAD2"),
        .init(name: "Water", iconName: "drop.fill", colorHex: "#2AAAD2"),
        .init(name: "Repairs", iconName: "wrench.and.screwdriver.fill", colorHex: "#60788A"),
        .init(name: "Home", iconName: "house.fill", colorHex: "#E58A33"),
        .init(name: "Hotel", iconName: "bed.double.fill", colorHex: "#E58A33"),
        .init(name: "Healthcare", iconName: "cross.case.fill", colorHex: "#F35E63"),
        .init(name: "Medicine", iconName: "pills.fill", colorHex: "#F35E63"),
        .init(name: "Shopping", iconName: "bag.fill", colorHex: "#5CCDC8"),
        .init(name: "Clothes", iconName: "tshirt.fill", colorHex: "#5CCDC8"),
        .init(name: "Delivery", iconName: "shippingbox.fill", colorHex: "#B58B4A"),
        .init(name: "Education", iconName: "book.closed.fill", colorHex: "#4D86C6"),
        .init(name: "Work", iconName: "laptopcomputer", colorHex: "#4D86C6"),
        .init(name: "Family", iconName: "person.2.fill", colorHex: "#F35E63"),
        .init(name: "Love", iconName: "heart.fill", colorHex: "#F35E63"),
        .init(name: "Pets", iconName: "pawprint.fill", colorHex: "#B58B4A"),
        .init(name: "Gifts", iconName: "gift.fill", colorHex: "#F35E63"),
        .init(name: "Games", iconName: "gamecontroller.fill", colorHex: "#7B61D8"),
        .init(name: "Movies", iconName: "movieclapper.fill", colorHex: "#7B61D8"),
        .init(name: "Fitness", iconName: "dumbbell.fill", colorHex: "#88C95A"),
        .init(name: "Beauty", iconName: "scissors", colorHex: "#E85D8E"),
        .init(name: "Garden", iconName: "leaf.fill", colorHex: "#88C95A"),
        .init(name: "Safety", iconName: "shield.fill", colorHex: "#60788A"),
        .init(name: "Salary", iconName: "briefcase.fill", colorHex: "#2AAAD2"),
        .init(name: "Cash", iconName: "banknote.fill", colorHex: "#21C596"),
        .init(name: "Money", iconName: "dollarsign.circle.fill", colorHex: "#21C596"),
        .init(name: "Office", iconName: "building.2.fill", colorHex: "#60788A"),
        .init(name: "Invest", iconName: "chart.line.uptrend.xyaxis", colorHex: "#2AAAD2"),
        ...
        .init(name: "Calendar", iconName: "calendar", colorHex: "#60788A"),
        .init(name: "Star", iconName: "star.fill", colorHex: "#F2C230")
    ]
