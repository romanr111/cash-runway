...
public final class DatabaseManager: @unchecked Sendable {
    ...
    public convenience init(locationProvider: DatabaseLocationProvider = .init(), allowsDestructiveRecovery: Bool = false) throws {
        try self.init(
            locationProvider: locationProvider,
            allowsDestructiveRecovery: allowsDestructiveRecovery,
            keychain: KeychainStore(service: "dev.roman.cash-runway")
        )
    }
